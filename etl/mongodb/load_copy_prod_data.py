...
# Exection : python /Users/sudheer.bomminenikroger.com/Desktop/work/git/spechub-data/etl/mongodb/load_copy_prod_data.py -c config/datalake.yaml -j mongodb -n load_copy_prod_data -a '{"storage_connection":""}' -v prod
...
class LoadCopyProdDataJob(DLETLBase):
    ...
    def copy_data_to_adls(self, container_name, collection_names, connection_string, db_name):
        ...
        try:
            ...
            for collection_name in collection_names:
                ...
                blob_name = f"{self.env}/{self.start_date}/{collection_name}.json"
